...
Home·체험 탐색/상세·Creator 목록/상세·About을 구현했습니다.
옵션 선택·예약·결제·Supabase 연결은 다음 Phase에서 구현합니다.
...
현재 변경은 `feat/phase-3-experience-discovery` 브랜치입니다. PHASE 2 브랜치를 기반으로 했으며,

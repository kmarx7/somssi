...
insert into public.sessions (experience_id,creator_id,venue_id,start_at,end_at,capacity,booked_count,status)
 select e.id,e.creator_id,'00000000-0000-0000-0000-000000000001'::uuid,'2026-10-20 10:30+09'::timestamptz,'2026-10-20 12:00+09'::timestamptz,6,2,'OPEN'::public.session_status from public.experiences e where e.slug='gayageum'
 union all select e.id,e.creator_id,'00000000-0000-0000-0000-000000000001'::uuid,'2026-10-20 15:00+09'::timestamptz,'2026-10-20 16:30+09'::timestamptz,6,4,'OPEN'::public.session_status from public.experiences e where e.slug='gayageum'
 union all select e.id,e.creator_id,'00000000-0000-0000-0000-000000000002'::uuid,'2026-10-22 14:00+09'::timestamptz,'2026-10-22 15:30+09'::timestamptz,6,1,'OPEN'::public.session_status from public.experiences e where e.slug='knot';
